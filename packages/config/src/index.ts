...
const rawConfigSchema = z
  .object({
    ...
    ci: z
      .object({
        fail_on: z.enum(["critical", "error", "warning", "info"]).optional(),
      })
      .optional(),
  })
  .strict();
...
export function defaultConfig(
  profile: RepositoryProfile = "public",
): ResolvedConfig {
  return {
    profile,
...
function resolveConfig(
  ...
  return {
    ...
    security: {
      ...
      redactFindings:
        raw.security?.redact_findings ?? defaults.security.redactFindings,
    },
  };
}
